 ...
 * @method self setId(null|array<string, mixed>|\Naugrim\BMEcat\Nodes\SupplierPid $id)
 * @method \Naugrim\BMEcat\Nodes\SupplierPid|null getId()
 * @method self setDetails(array<string, mixed>|\Naugrim\BMEcat\Nodes\Product\Details $details)
 * @method \Naugrim\BMEcat\Nodes\Product\Details getDetails()
 * @method self setFeatures(\Naugrim\BMEcat\Nodes\Product\Features[]|array<string, mixed> $features)
 * @method \Naugrim\BMEcat\Nodes\Product\Features[] getFeatures()
 * @method self setOrderDetails(array<string, mixed>|\Naugrim\BMEcat\Nodes\Product\OrderDetails $orderDetails)
 * @method \Naugrim\BMEcat\Nodes\Product\OrderDetails getOrderDetails()
 * @method self setPriceDetails(\Naugrim\BMEcat\Nodes\Product\PriceDetails[]|array<string, mixed> $priceDetails)
 ...
 * @method self setLogisticDetails(array<string, mixed>|\Naugrim\BMEcat\Nodes\Product\LogisticDetails $logisticDetails)
 * @method \Naugrim\BMEcat\Nodes\Product\LogisticDetails getLogisticDetails()
 * @method self setConfigDetails(array<string, mixed>|\Naugrim\BMEcat\Nodes\Product\ConfigDetails $configDetails)
